//http://192.168.11.16:8680/doc/doc/detail.htm?methodId=8423
...
searchContent         |          String         |          最近搜索的内容,按照|||分开,如关键字1|||关键字2|||关键字3
...
describe('你可能感兴趣的套装：三层逻辑，一是最近查看过的套装，二是用户最近搜索，三是用户关注的角色，此三种数据随机推荐；
 如果前三种都没数据，或者是数据不够，则在相应的数据后面展示除本套装外最近添加的。注意不要在一页展示2个一样的套装。
 
 目前最近查看的,陈波处未记录,暂时未做', function () {
