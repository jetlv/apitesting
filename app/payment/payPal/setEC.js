...
describe('PayPal支付流程第一步：开始结账。（用于Milanoo内部订单支付）', function () {

   it('基本验证', function (done) {

       var fullPath = 'http://192.168.11.16:8080/payment/payPal/setEC.htm?params.returnUrl=http://boss.milanoodeals.com/payment/payPal/ipnHandler.htm
 &params.cancelUrl=http://test.item.www.milanoo.com/shop/Payment-id-2146729.html&params.viewType=WEBSITE&params.orderId=2146729';
       tester.get(__path(__filename) + 'params.returnUrl=http://boss.milanoodeals.com/payment/payPal/ipnHandler.htm
 &params.cancelUrl=http://test.item.www.milanoo.com/shop/Payment-id-2146729.html&params.viewType=WEBSITE&params.orderId=2146729')
