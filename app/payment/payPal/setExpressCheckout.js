...
/** PayPal支付流程第一步：开始结账。(用于第三方支付，如分销平台)**/
...
describe('setExpressCheckout', function () {

   it('基本验证', function (done) {

       var fullPath = 'http://192.168.11.16:8080/payment/payPal/setExpressCheckout.htm?params.localCode=US&params.returnUrl=http://milanoo.kancart.com/paypalecreturn.php&params.cancelUrl=http://milanoo.kancart.com/paypaleccancel.php?type=order&params.paymentType=EC&params.viewType=WEBSITE';
       tester.get(__path(__filename) + 'params.localCode=US&params.returnUrl=http://milanoo.kancart.com/paypalecreturn.php&params.cancelUrl=http://milanoo.kancart.com/paypaleccancel.php')
