...
describe('获取订单', function () {
    it('根据用户ID获取订单', function (done) {
        ...
        tester.get(__path() + 'websiteIdLastView=1&memberId=3662895&searchContent=&ordersEstate=0&type=&pageNo=1&pageSize=5&languageCode=en-uk&websiteIdFilter=&isComment=&websiteId=1&deviceType=5')
            .expect(200)
