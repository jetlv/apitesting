//http://192.168.11.16:8680/doc/doc/detail.htm?methodId=8107
//AUTOMATICALLY GENERATED, NEED TO BE MODIFIED


/**
参数名称         |          参数类型         |          参数说明
memberId         |          String         |          用户ID，登录用户不能为空
...
describe('保存游戏分数并返回战况及以相应折扣券Id。（用户可以根据自身条件选择接受此折扣券或再次挑战）
 注意：此接口与{@link GameController#saveGameRecords(String, String, String, String, String)} 接口不同。', function () {
